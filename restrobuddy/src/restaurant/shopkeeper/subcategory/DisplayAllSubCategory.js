...
{   const classes = useStyles()
    ...
    const fetchAllSubcategoryData=async()=>{
        var res=await postData('subcategory/fetch_all_subcategory_data',{'restaurantid':restaurantId})
    ...
    const fetchAllCategory=async()=>{
        var response=await postData("subcategory/fetch_all_category",{'restaurantid':restaurantId})
        ...
        return(<MaterialTable
            ...
            actions={[
                ...
                },
                {
                    ...
                    onClick: (event, rowData) => navigate('/shopkeeperdashboard/subcategoryinterface')
                  }
            ]}
            />)
    }
